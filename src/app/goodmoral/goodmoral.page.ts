...
@Component({
  selector: 'app-goodmoral',
  templateUrl: './goodmoral.page.html',
  styleUrls: ['./goodmoral.page.scss'],
})
export class GoodmoralPage implements OnInit {

  selectedFile: File | null = null;
  uploadProgress: number | null = null;
  downloadURL: string | null = null;
  files: any[];
  folderPath = '/GoodMoral'; // Replace with your Firebase Storage folder path
  contents: any[] = [];
  searchText: string = '';
  ...
  constructor(private router: Router, private fileUploadService: FileUploadService, 
    ...
    uploadFile(): void{
      if(this.selectedFile){
        this.fileUploadService.uploadFile(this.selectedFile, 'GoodMoral').subscribe(
          (url) => {
